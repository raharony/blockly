...
Blockly.Msg.TEXT_THYMIO_SUBROUTINE_DEFINE_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_SUBROUTINE_DEFINE_TOOLTIP = 'Defines subroutines';
Blockly.Msg.TEXT_THYMIO_EVENT_BUTTON_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_EVENT_BUTTON_TOOLTIP = 'React to a button press or release event';
Blockly.Msg.TEXT_THYMIO_EVENT_PROX_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_EVENT_PROX_TOOLTIP = 'React to a proximity event';
Blockly.Msg.TEXT_THYMIO_EVENT_PROX_GROUND_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_EVENT_PROX_GROUND_TOOLTIP = 'React to a ground proximity event';
Blockly.Msg.TEXT_THYMIO_EVENT_SHOCK_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_EVENT_SHOCK_TOOLTIP = 'React to a shock event';
Blockly.Msg.TEXT_THYMIO_EVENT_TIMER_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_EVENT_TIMER_TOOLTIP = 'React to an expired timer event';
Blockly.Msg.TEXT_THYMIO_EVENT_SOUND_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_EVENT_SOUND_TOOLTIP = 'React to a sound event';
Blockly.Msg.TEXT_THYMIO_EVENT_RECEIVE_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_EVENT_RECEIVE_TOOLTIP = 'React to a receive event';
Blockly.Msg.TEXT_THYMIO_EVENT_UPDATE_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_EVENT_UPDATE_TOOLTIP = 'React to an update event';
Blockly.Msg.TEXT_THYMIO_LED_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_LED_TOOLTIP = 'Sets a LED to a specified color';
Blockly.Msg.TEXT_THYMIO_LED_RGB_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_LED_RGB_TOOLTIP = 'Sets a LED to a specified color by RGB values';
Blockly.Msg.TEXT_THYMIO_LED_CIRCLE_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_LED_CIRCLE_TOOLTIP = 'Sets the circle LEDs';
Blockly.Msg.TEXT_THYMIO_LED_PROX_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_LED_PROX_TOOLTIP = 'Sets the horizontal proximity LEDs';
Blockly.Msg.TEXT_THYMIO_LED_PROX_GROUND_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_LED_PROX_GROUND_TOOLTIP = 'Sets the ground proximity LEDs';
Blockly.Msg.TEXT_THYMIO_LED_BUTTON_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_LED_BUTTON_TOOLTIP = 'Sets the button LEDs';
Blockly.Msg.TEXT_THYMIO_LED_TEMPERATURE_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_LED_TEMPERATURE_TOOLTIP = 'Sets the temperature LEDs';
Blockly.Msg.TEXT_THYMIO_LED_RC_SOUND_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_LED_RC_SOUND_TOOLTIP = 'Sets the remote control and sound LEDs';
Blockly.Msg.TEXT_THYMIO_LED_OFF_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_LED_OFF_TOOLTIP = 'Turns off a LED';
Blockly.Msg.TEXT_THYMIO_SOUND_SYSTEM_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_SOUND_SYSTEM_TOOLTIP = 'Plays a system sound';
Blockly.Msg.TEXT_THYMIO_SOUND_NOTE_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_SOUND_NOTE_TOOLTIP = 'Plays a note of a frequency for a duration';
Blockly.Msg.TEXT_THYMIO_SOUND_STOP_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_SOUND_STOP_TOOLTIP = 'Stops playing sound';
...
Blockly.Msg.TEXT_THYMIO_PROX_CHECK_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_PROX_CHECK_TOOLTIP = 'Checks if a proximity sensor is blocked';
Blockly.Msg.TEXT_THYMIO_PROX_GROUND_CHECK_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_PROX_GROUND_CHECK_TOOLTIP = 'Checks if a proximity sensor is blocked';
Blockly.Msg.TEXT_THYMIO_SENSOR_TEMPERATURE_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_SENSOR_TEMPERATURE_TOOLTIP = 'Retrieves the temperature sensor value';
Blockly.Msg.TEXT_THYMIO_SENSOR_MIC_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_SENSOR_MIC_TOOLTIP = 'Retrieves the microphone intensity value';
Blockly.Msg.TEXT_THYMIO_SENSOR_COMM_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_SENSOR_COMM_TOOLTIP = 'Retrieves the received IR communication value';
Blockly.Msg.TEXT_THYMIO_SENSOR_PROX_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_SENSOR_PROX_TOOLTIP = 'Retrieves the closeness of a proximity sensor';
Blockly.Msg.TEXT_THYMIO_SENSOR_MOTOR_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_SENSOR_MOTOR_TOOLTIP = 'Retrieves the speed of a motor';
Blockly.Msg.TEXT_THYMIO_SENSOR_ACC_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_SENSOR_ACC_TOOLTIP = 'Retrieves a accelerometer sensor value';
Blockly.Msg.TEXT_THYMIO_SENSOR_RC_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_SENSOR_RC_TOOLTIP = 'Retrieves a remote control sensor value';
Blockly.Msg.TEXT_THYMIO_MOTORS_START_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_MOTORS_START_TOOLTIP = 'Starts Thymio\'s motors';
Blockly.Msg.TEXT_THYMIO_MOTORS_STOP_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_MOTORS_STOP_TOOLTIP = 'Stops Thymio\'s motors';
Blockly.Msg.TEXT_THYMIO_ACTUATOR_SET_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_ACTUATOR_SET_TOOLTIP = 'Sets an actuator variable on the Thymio';
Blockly.Msg.TEXT_THYMIO_ACTUATOR_MIC_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_ACTUATOR_MIC_TOOLTIP = 'Sets Thymio\'s microphone threshold';
Blockly.Msg.TEXT_THYMIO_ACTUATOR_COMM_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_ACTUATOR_COMM_TOOLTIP = 'Sets the IR communication value to send';
Blockly.Msg.TEXT_THYMIO_ACTUATOR_TIMER_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_ACTUATOR_TIMER_TOOLTIP = 'Sets a timer period variable on the Thymio';
Blockly.Msg.TEXT_THYMIO_ACTUATOR_MOTOR_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_ACTUATOR_MOTOR_TOOLTIP = 'Sets a motor speed on the Thymio';
Blockly.Msg.TEXT_THYMIO_DECLARE_ARRAY_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
Blockly.Msg.TEXT_THYMIO_DECLARE_ARRAY_TOOLTIP = 'Declares an array of a certain size';
Blockly.Msg.TEXT_THYMIO_SET_ARRAY_HELPURL = 'https://www.thymio.org/en:thymiotutorielp2';
